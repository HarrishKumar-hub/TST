            ...
            {isVisible && (
                ...
                >
                    ...
                    >
                        ...
                        {/* High-Impact Header */}
                        <div className="bg-white text-text-slate-dark p-8 relative border-b border-gray-100">
                            <Search size={48} className="text-amber-600 mb-4 opacity-20 absolute right-8 top-8" />

                            <h2 className="text-3xl font-heading font-black uppercase mb-2 relative z-10">
                                Still Looking For The <span className="text-amber-600">Right Iron?</span>
                            </h2>

                    ...
                    >
                        ...
                        <div className="bg-white p-4 flex items-center justify-between border-b border-gray-100 relative">
                            <div className="flex items-center gap-3 relative z-10">
                                <div className="w-10 h-10 rounded-full bg-amber-600 flex items-center justify-center font-heading font-black text-xl text-white">
                                    K
                                </div>
                                <div>
                                    <h4 className="text-text-slate-dark font-bold leading-none mb-1">Kumar Consultancy</h4>
                            ...
                            <button onClick={() => setIsOpen(false)} className="text-gray-400 hover:text-text-slate-dark relative z-10">
                                <X size={20} />
                            </button>
                        </div>

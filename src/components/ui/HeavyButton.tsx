...
export function HeavyButton({ variant = 'default', children, className = '', ...props }: ButtonProps) {
    ...
    const variants = {
        default: 'bg-gradient-to-r from-amber-600 to-amber-500 text-white shadow-md hover:shadow-xl hover:shadow-amber-600/20 ring-1 ring-white/10',
        outline: "bg-white border border-gray-200 text-text-slate hover:border-amber-600 hover:text-amber-600 hover:shadow-md"
    };

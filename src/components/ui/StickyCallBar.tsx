        ...
        <AnimatePresence>
            {isVisible && (
                ...
                >
                    ...
                    <div className="bg-white border-t-2 border-amber-600 flex divide-x divide-gray-200 h-16 shadow-lg">
                        <Link
                            href="tel:+919443744349"
                            className="flex-1 flex flex-col items-center justify-center text-text-slate-dark active:bg-gray-100 transition-colors"
                        >
                            <Phone size={20} className="mb-1 text-amber-600" />

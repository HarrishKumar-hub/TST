                ...
                <div className="flex justify-between items-center py-5 min-h-[6.5rem]">
                    ...
                    <nav className="hidden md:flex items-center space-x-8">
                        ...
                        <a
                            ...
                            className="bg-amber-600 text-white px-6 py-3 font-sans font-semibold text-sm hover:shadow-lg hover:shadow-amber-600/30 hover:-translate-y-0.5 transition-all rounded-full relative overflow-hidden group"
                        >
